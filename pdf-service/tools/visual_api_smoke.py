        ...
        records.append(
            {
                ...
                "material_group_id": item.get("material_group_id"),
                "material_group_question_indexes": item.get("material_group_question_indexes") or [],
                "material_group_confidence": item.get("material_group_confidence"),
                "shared_material": bool(item.get("shared_material")),
